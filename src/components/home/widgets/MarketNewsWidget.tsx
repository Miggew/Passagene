...
export function MarketNewsWidget({ compact = false }: { compact?: boolean }) {
    ...
    return (
        <Card className="h-full min-h-0 glass-panel border-border/50 p-3 flex flex-col justify-between shadow-sm overflow-hidden hover:shadow-md transition-shadow">
