      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {atalhos.map((item) => (
          <button
            ...
            className="flex items-center gap-3 p-3 rounded-xl border border-border glass-panel hover:border-primary/30 hover:bg-gradient-to-r hover:from-primary/5 hover:to-transparent transition-all group text-left"
          >
