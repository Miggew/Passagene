...
export default function EscritorioP1() {
  ...
  if (saved) {
    return (
      <div className="space-y-6 animate-in fade-in duration-500">
        <PageHeader title="Protocolo — 1º Passo" icon={Syringe} />
        <Card>
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <PageHeader
        ...
        description="Cadastrar novo protocolo com receptoras. Digite o registro e use Tab para navegar."
        icon={Syringe}
      />
