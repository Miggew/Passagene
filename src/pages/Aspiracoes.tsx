...
export default function Aspiracoes() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Aspira├º├úo Folicular"
        description="Registre novas sess├Áes de aspira├º├úo de o├│citos (OPU)"
      />
      ...
      <AlertDialog open={showRestaurarDialog} onOpenChange={setShowRestaurarDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Existe uma sess├úo de aspira├º├úo n├úo finalizada salva em seu navegador.
              Deseja continuar de onde parou?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={descartarRascunho}>Descartar</AlertDialogCancel>
            <AlertDialogAction onClick={restaurarRascunho}>Restaurar Sess├úo</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </div>
