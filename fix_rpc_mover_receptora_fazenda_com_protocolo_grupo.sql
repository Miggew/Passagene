-- ============================================================
-- Fix: RPC mover_receptora_fazenda com remoção e agrupamento
-- ============================================================
-- Objetivo: Quando receptoras são movidas durante sincronização,
--           remover do protocolo original e adicionar a protocolo
--           equivalente na nova fazenda, agrupando receptoras do
--           mesmo protocolo original no mesmo protocolo destino
-- ============================================================
...
BEGIN
    ...
    IF v_protocolo_original_id IS NOT NULL THEN
        ...
        -- 7.2. Tentar encontrar protocolo "espelho" na nova fazenda
        ...
        -- 7.3. Se não encontrou protocolo "espelho", criar um novo
        IF v_protocolo_destino_id IS NULL THEN
            INSERT INTO protocolos_sincronizacao (
                ...
                status,
                observacoes,
                protocolo_origem_id  -- Rastrear protocolo original
            )
            VALUES (
                p_nova_fazenda_id,
                ...
                v_protocolo_original_id  -- Rastrear protocolo original
            )
        ...
        -- 7.4. Adicionar receptora ao protocolo destino (ou recém-criado, ou existente)
...
COMMENT ON FUNCTION mover_receptora_fazenda IS 'Move uma receptora para uma nova fazenda. Se estiver em protocolo ativo, remove do protocolo original e adiciona a protocolo equivalente na nova fazenda, agrupando receptoras do mesmo protocolo original no mesmo protocolo destino.';
