...
-- Atualiza receptoras individuais diretamente
-- ============================================================================

-- CORREÇÃO 1: Atualizar receptoras descartadas (INAPTA) para VAZIA
-- Primeiro, vamos listar todas as receptoras que precisam ser corrigidas
SELECT 
...
-- Atualizar usando UPDATE direto com subquery
UPDATE receptoras
...
-- Listar receptoras que precisam ser corrigidas
SELECT 
    r.id as receptora_id,
    r.identificacao,
    pr.status as status_no_protocolo,
...
-- VERIFICAÇÃO FINAL: Listar todas as inconsistências restantes
