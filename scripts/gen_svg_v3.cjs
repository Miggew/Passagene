...
// timeProgress = 0.5 to give a nice twist shape
...
// The container holding the DNA points is only 60% of the viewBox height!
const containerHeight = innerSize * 0.60;
const H = containerHeight - dotSize;
...
console.log('SVGs exactly matching the React component generated successfully!');
