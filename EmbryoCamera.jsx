...
// ─── COMPONENT ───
export default function EmbryoCamera() {
  ...
  return (
    <div style={{ fontFamily: font, background: P.bg, color: P.text, minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      {/* ═══ HEADER ═══ */}
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 20px", borderBottom: `1px solid ${P.border}`, background: P.surface }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ width: 34, height: 34, borderRadius: 9, background: `linear-gradient(135deg, ${P.accent}, #6366f1)`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 }}>🔬</div>
          <div>
            <div style={{ fontWeight: 700, fontSize: 15, letterSpacing: "-0.01em" }}>PassaGene Câmera</div>
            <div style={{ fontSize: 10, color: P.textMuted, marginTop: 1, display: "flex", alignItems: "center", gap: 6 }}>
              Captura profissional para análise AI
              {saveIndicator && <span style={{ color: P.success, fontSize: 10, fontWeight: 600, animation: "fadeIn 0.2s" }}>✓ Salvo</span>}
            </div>
          </div>
        </div>
        {phase !== "config" && (
          <button onClick={phase === "camera" ? closeCamera : discardAndReturn} style={{ background: "none", border: `1px solid ${P.border}`, color: P.textDim, padding: "5px 12px", borderRadius: 8, fontSize: 12, cursor: "pointer" }}>← Voltar</button>
        )}
      </header>
      ...
      {phase === "config" && (
        <div style={{ flex: 1, overflow: "auto", padding: "0 16px 20px" }}>
          ...
          {/* Summary bar */}
          <div style={{ margin: "14px 0", padding: "10px 14px", background: P.surfaceAlt, borderRadius: 10, display: "flex", flexWrap: "wrap", gap: "6px 14px", fontFamily: mono, fontSize: 11, color: P.textDim }}>
      ...
      {phase === "preview" && recordedUrl && (
        <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "auto" }}>
          ...
          <div style={{ padding: 16 }}>
            ...
            <button disabled style={{ width: "100%", marginTop: 10, padding: "13px", borderRadius: 11, border: `1px dashed ${P.border}`, background: P.surfaceAlt, color: P.textMuted, fontSize: 12, cursor: "not-allowed", opacity: 0.7 }}>🧠 Enviar para Análise AI (em breve)</button>
          </div>
        </div>
      )}
    </div>
